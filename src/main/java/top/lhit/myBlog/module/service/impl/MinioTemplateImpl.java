...
public class MinioTemplateImpl implements IMinioTemplate {
    ...
    @Override
    public CompletionStage<CommonResult> putObjectForFile(MultipartFile file) {
        return CompletableFuture.supplyAsync(()->{
            String fileUploadState = putObject(file);
            log.info("file upload url : => {}",fileUploadState);
            return CommonResult.success("woc niubi ");
        });
    }
